...
def getJSON(foodItem,current_location_lat,current_location_lng):
	...
	url = "https://api.foursquare.com/v2/venues/search?ll=%f,%f&limit=5&query=%s&radius=2500&oauth_token=QBYJF4RXJRYJNYEHWQDHAX54D04ORLKEVKPDTFTSYIUJZXPW&v=20150603" %(lat,lang,foodItem)
